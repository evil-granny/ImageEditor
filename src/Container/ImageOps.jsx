                    ...
                    <Grid item xs={6}>
                        <Card>
                            <CardContent>
                                ...
                                <Image publicId="dog_1_fsvl2c" cloudName="drkcpkne4">
                            ...
                            <CardContent>
                                <Box color="text.primary">
                                    ...
                                    {this.getRBBCons().map((color) => {
                                        return (
                                            <SliderComponent getSliderValue={(key) => this.getSliderValue(key, "rgb")}
                                                             default={0} min={-100} max={100} keyLabel={color.key}
                                    ...
                                    <Button variant="contained" align="left"
                                            onClick={() => this.resetFilters(["red", "green", "blue"])} color="primary">
                                        Reset
                                    </Button>
                            ...
                            <CardContent>
                                <Box color="text.primary">
                                    ...
                                    {this.getHSVCons().map((color) => {
                                        return (
                                            <SliderComponent getSliderValue={(key) => this.getSliderValue(key, "hsv")}
                                                             default={0} min={-100} max={100} keyLabel={color.key}
                                                             keyValue={color.value}
                                                             updateColorValue={(e, value, key) => this.updateColorValue(e, value, key)}/>
                                        )
                                    ...
                                    <Button variant="contained" align="left"
                                            onClick={() => this.resetFilters(["hue", "saturation", "brightness"])}
                                            color="primary">
                                        Reset
                                    </Button>
                        ...
                        <Card item xs={6}>
                            <CardContent>
                                <Box color="text.primary">
                                    ...
                                    <Button variant="contained" align="left"
                                            onClick={() => this.resetFilters(["vignette", "cartoonify", "vibrance", "oil_paint"])}
                                            color="primary">
                                        Reset
                                    </Button>
